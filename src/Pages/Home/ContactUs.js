...
const ContactUs = () => {
    ...
    return (
        <div className='grid grid-cols lg:grid-cols-2 bg-black '>
            <div className='mt-12 pt-28 lg:ml-20'>
                <div className='w-full lg:w-4/6 p-3'>
                    <div>
                ...
                <div  className=" flex-shrink-0 w-full lg:w-5/6 p-3 my-8">
